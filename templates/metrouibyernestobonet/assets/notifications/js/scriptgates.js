...
(function (b) {
    b.MetroMessageBox = function (v, a) {
        ...
        if (isIE8orlower() == 0) {
            ...
            i.setAttribute("src","../../templates/metrouibyernestobonet/assets/notifications/sound/messagebox.mp3");
            b.get();
...
(function (b) {
    b.bigBox = function (a, h) {
        ...
        if (isIE8orlower() == 0) {
            var i = document.createElement("audio");
                       i.setAttribute("src", "../../templates/metrouibyernestobonet/assets/notifications/sound/bigbox.mp3");
            b.get();
            i.addEventListener("load", function () {
                i.play()
            }, true);
        ...
        BigBoxes = BigBoxes + 1;
        k = "<div id='bigBox" + BigBoxes + "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" + BigBoxes + "'><img class='botClose' id='botClose" + BigBoxes + "' src='../img/close.png'>";
        k += "<span>" + a.title + "</span>";
        k += "<p>" + a.content + "</p>";
...
(function (b) {
    b.smallBox = function (o, j) {
        ...
        if (isIE8orlower() == 0) {
            ...
            k.setAttribute("src", "../../templates/metrouibyernestobonet/assets/notifications/sound/smallbox.mp3");
            b.get();
