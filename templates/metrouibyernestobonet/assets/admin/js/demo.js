...
$(function () {
  ...
  demo_settings.append(
          "<h4 class='text-light-blue' style='margin: 0 0 5px 0; border-bottom: 1px solid #ddd; padding-bottom: 15px;'>Configurar la Vista</h4>"
          //Fixed layout
  ...
  var skin_blue =
          ...
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-blue\")' " +
                    "style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  + "<div><span style='display:block; width: 20%; float: left; height: 10px; background: #9e1546;'></span><span class='bg-light-excelencia' style='display:block; width: 80%; float: left; height: 10px;'></span></div>"
                  ...
                  + "<p class='text-center'>Estilo MIC</p>"
                  + "</a>");
  skins_list.append(skin_blue);
  var skin_black =
          $("<li />", {style: "float:left; width: 50%; padding: 5px;"})
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-black\")' " +
                    "style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  ...
                  + "<p class='text-center'>Estilo Negro</p>"
                  + "</a>");
  ...
  var skin_purple =
          ...
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-purple\")' style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  ...
                  + "<div><span style='display:block; width: 20%; float: left; height: 40px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;'></span></div>"
                  + "<p class='text-center'>Estilo Púrpura</p>"
                  + "</a>");
  ...
  var skin_green =
          ...
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-green\")' style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  ...
                  + "<div><span style='display:block; width: 20%; float: left; height: 40px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;'></span></div>"
                  + "<p class='text-center'>Estilo Verde</p>"
                  + "</a>");
  skins_list.append(skin_green);
    var skin_red =
          ...
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-red\")' style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  ...
                  + "<div><span style='display:block; width: 20%; float: left; height: 40px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;'></span></div>"
                  + "<p class='text-center'>Estilo Rojo</p>"
                  + "</a>");
  skins_list.append(skin_red);
    var skin_yellow =
          ...
          .append("<a href='javascript:void(0);' onclick='change_skin(\"skin-yellow\")' style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  ...
                  + "<div><span style='display:block; width: 20%; float: left; height: 40px; background: #222d32;'></span><span style='display:block; width: 80%; float: left; height: 40px; background: #f4f5f7;'></span></div>"
                  + "<p class='text-center'>Estilo Amarillo</p>"
                  + "</a>");
  skins_list.append(skin_yellow);

  demo_settings.append("<h4 class='text-light-blue' style='margin: 0 0 5px 0; border-bottom: 1px solid #ddd; padding-bottom: 15px;'>Estilos</h4>");
