...
defined('_JEXEC') or die; 
    ...
    function getfunction()
   {
        ...
        return $result;
    	  ...
    	  $controller	= JControllerLegacy::getInstance('financiamiento_programa_proyecto');
         $task=JFactory::getApplication()->input->get('task');
		  if($task==null)
			{
			    $accion=getfunction();
               if($accion=='financiamiento-programa-proyecto')
                $accion="financiamiento_programa_proyecto";
			    if($accion)
