...
jimport('joomla.application.component.controller');
    class programa_auditoria extends JModelLegacy
{
	...
	function __construct( &$db ) {
        ...
        $this->repConvocatoriatable=JTable::getInstance('programa_auditoria');
 ...
 function is_null()    
{
    ...
    function loadAllItem($key,$where=null)
    {
        ...
        foreach($lista as $item)
        {
            ...
            $trazaitem=JModelLegacy::getInstance('programa_auditoria');
            $trazaitem->load($pk);
   ...
   function getTrazaModelArray($condition)    {
       ...
       $trazalist=$this->loadAll('*',$condition);
        ...
        foreach($trazalist as $item)
        {
            ...
            $item=JModelLegacy::getInstance('programa_auditoria');
          	 $item->load($trazapk);
