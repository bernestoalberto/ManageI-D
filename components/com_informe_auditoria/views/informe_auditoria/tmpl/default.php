...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        ...
        <li ><a data-toggle="tab" href="#lista">LISTA CHEQUEO</a></li>
        <li  class="active"><a data-toggle="tab" href="#proof">EVIDENCIAS OBJETIVAS</a></li>
    ...
    <div class="tab-content">
        ...
        <div id="proof" class="tab-pane active">
