...
defined('_JEXEC') or die; 
    ...
    function getfunction()
   {
        ...
        return $result;
    	  ...
    	  $controller	= JControllerLegacy::getInstance('Documentacion_evidencias_objetivas');
         $task=JFactory::getApplication()->input->get('task');
		  if($task==null)
			{
			    $accion=getfunction();
               if($accion=='documentacion-evidencias-objetivas') 
                $accion="documentacion_evidencias_objetivas"; 
			    if($accion)
