...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active" ><a data-toggle="tab" href="#programa">Programa</a></li>
        <li ><a data-toggle="tab" href="#convocatoria">Convocatoria</a></li>
    ...
    <div class="tab-content">
        ...
        <div id="convocatoria" class="tab-pane ">
            <div  >
                <section class="content-header">
                    <h1>
