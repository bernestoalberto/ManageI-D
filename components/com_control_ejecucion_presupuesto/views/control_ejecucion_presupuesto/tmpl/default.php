...
<head>
    ...
    <title>Control Ejecución del Presupusto  </title>
...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a data-toggle="tab" href="#contro_exe_pre">Presupuesto</a></li>
    ...
    <div class="tab-content">
        ...
        <div id="contro_exe_pre" class="tab-pane active">
            <div>
