...
defined('_JEXEC') or die; 
    ...
    function getfunction()
   {
        ...
        return $result;
    	  ...
    	  $controller	= JControllerLegacy::getInstance('Dictamen_grupo_expertos_inf_etapa');
         $task=JFactory::getApplication()->input->get('task');
		  if($task==null)
			{
			    $accion=getfunction();
               if($accion=='dictamen-grupo-expertos-inf-etapa') 
                $accion="dictamen_grupo_expertos_inf_etapa"; 
			    if($accion)
