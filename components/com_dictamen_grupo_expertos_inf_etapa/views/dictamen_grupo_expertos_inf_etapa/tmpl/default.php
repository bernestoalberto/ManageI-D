...
<head>
    ...
    <title>Dictámen del Grupo de Expertos sobre Informe de Etapa </title>
...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="input-group margin" id= "div_id_proyecto">
                          	<span class="input-group-btn" title=" se define lid_proyecto">
                			<label for="id_proyecto" class="btn-addons " style="padding-right: 5px;">Código Proyecto*</label></span>
        ...
        <div id="dictamen" class="tab-pane active">
                ...
                <div id="informe_ejecucion_programa_window" style="display: none;" >
                    ...
                    <div class="box-gestionando box-primary">
                        ...
                        <form role="form" method="post" id="informe_ejecucion_programa_form" class="form-validate">
                			...
                			<label for="cumplimiento_objtvs_propuestos" class="btn-addons " style="padding-right: 5px;">Cumplimiento Objtvs Propuestos*</label></span>
