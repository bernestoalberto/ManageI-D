...
<head>
    ...
    <title>Certificación Actividades y Resultados </title>
...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#certify">Actividades Resultados</a></li>
        <li ><a data-toggle="tab" href="#contro_exe_pre">Presupuesto</a></li>
        <li><a data-toggle="tab" href="#infrm_etapa">Etapa</a></li>
    </ul>
    <div class="tab-content">


        <div id="certify" class="tab-pane active ">
            <div >
        ...
        <div id="infrm_etapa" class="tab-pane ">
            <div >
