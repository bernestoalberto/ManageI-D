...
<head>
    ...
    <title>Informe de Ejecución del Programa </title>
...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a data-toggle="tab" href="#exe_program">Ejecución Programa</a></li>
    ...
    <div class="tab-content">
        ...
        <div id="exe_program" class="tab-pane active">
