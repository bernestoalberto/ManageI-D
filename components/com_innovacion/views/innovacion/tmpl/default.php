...
<div class="nav-tabs-custom">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a data-toggle="tab" href="#innovation">Innovación</a></li>
		<li><a data-toggle="tab" href="#in_de">I+D</a></li>
	...
	<div class="tab-content">
		...
		<div id="innovation" class="tab-pane active">
			<div >
