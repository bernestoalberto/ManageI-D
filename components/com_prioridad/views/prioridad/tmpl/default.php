...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#prioridad">Prioridad</a></li>
        ...
        <li><a data-toggle="tab" href="#state">Estado Ejecución</a></li>
        <li><a data-toggle="tab" href="#problems">Problema Detectado</a></li>

    </ul>
    <div class="tab-content">
        <div id="prioridad" class="tab-pane active">
            <div >
                ...
                <div id="prioridad_window" style="display: none;" >
                    ...
                    <div class="box-gestionando box-primary">
                        ...
                        <form role="form" id="prioridad_form" class="form-validate" method="post">
                			...
                			<span class="input-group-btn" title="Se define el problema a resolver para un programa o
                			 un proyecto no asociado a programa.">
